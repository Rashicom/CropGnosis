    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('feature_type', models.CharField(choices=[('BASE_SUBSCRIPTION_FEATURE', 'BASE_SUBSCRIPTION_FEATURE'), ('ADD_ON_FEATURE', 'ADD_ON_FEATURE')])),
            ],
            options={
                'ordering': ['-created_at'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('FARMER', 'FARMER'), ('MENTOR', 'MENTOR')], default='FARMER', max_length=50)),
